...
public class GameLauncher extends JFrame{
	...
	//creating the gui for the launcher which takes the appropriate options for the game to be played
	public GameLauncher(){
		...
		sizeLabel.setBounds(50, 80, 60,30);
		...
		quitButton.setBounds(100, 120, 60,30);
